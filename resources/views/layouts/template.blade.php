...
<link type="text/css" rel="stylesheet" href="{{ asset('css/jquery.bxslider.css') }}">
...
<script>
	var activity_cal_api_url = "{{ route("activity_url") }}";
	var provider_activity_cal_api_url = "{{ route("activity_provider_url") }}";
</script>
</head>
@if(Auth::user())
	@php
				...
				<nav class="navbar navbar-expand-lg navbar-light nav-padding">
				  ...
				  <div class="collapse navbar-collapse" id="navbarSupportedContent">
				   ...
				   <ul class="navbar-nav kid-menu right-menu">
					...
					@if(auth()->user() == null)
						@if(!(request()->is('login')))
							<li class="nav-item {{ request()->is('register') ? 'Highlight-menu' : 'menus' }}">
					    		<a class="nav-link" href="{{ route('login') }}"><i class="fas fa-sign-in-alt login-icon"></i>LOG IN</a>
							</li>
						@endif
