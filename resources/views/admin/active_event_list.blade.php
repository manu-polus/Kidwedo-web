...
<div class="box-header">
    <h3 class="box-title">Active Events</h3>
</div>
...
<div class="box-body table-responsive no-padding">
              ...
              <thead>
                ...
                @forelse($active_events as $active_event)
                @php
                    $formdata=json_encode($active_event,JSON_HEX_APOS);
                @endphp
                <tr>
                  <td>{{ $count++ }}</td>
                  <td>{{ $active_event->event_name }}</td>
                  <td>{{ $active_event->business_name }}</td>
                  <td>
                ...
                <tr class="text-center">
			        <td>
				        <td colspan="3">LOOKS LIKE NO ACTIVE EVENTS FOUND</td>
				    </td>
		        </tr>
                @endforelse
              </table>
