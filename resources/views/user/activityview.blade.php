...
<section class="container-fluid register-bg">
				...
				<div class="activity-view mb-20 w-100">
							...
							<div class="row">
								...
								<div class="col-lg-3">
									<div class="time-credit-box w-100">
										...
										@if($user_booked)
										<button type="button" class="kid-btn kid-small-btn w-100" onclick="window.open('{{ $ticket_url }}', '_blank')">TICKET DRUCKEN</button>
										@else
                    ...
                    <p><a href="{{ route('activity.view',['id' => $activities->event_date_id]) }}">
                        @php
